export function appPasswordResetTemplate(name: string, siteLink: string) {
	...
	<p
		...
		"
	>
		A password reset has been requested for your UET app account
	</p>
	...
	<div>
		<!--[if mso]>
			<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${siteLink}" style="height:40px;v-text-anchor:middle;width:200px;" arcsize="50%" stroke="f" fillcolor="#FFCD34">
	  		...
	  		<center>
		<![endif]-->
		<a href="${siteLink}" style="background-color:#FFCD34;border-radius:20px;color:#171A1D;display:inline-block;font-family:sans-serif;font-size:13px;font-weight:bold;line-height:40px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Reset Password</a>
		<!--[if mso]>
	  		</center>
			</v:roundrect>
  		<![endif]--></div>
